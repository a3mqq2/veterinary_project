...
@section('title', __('messages.add_region'))
                ...
                <form action="{{ route('regions.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="{{ __('messages.enter_region_name_ar') }}" required>
                            @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name_en" class="form-control @error('name_en') is-invalid @enderror" value="{{ old('name_en') }}" placeholder="{{ __('messages.enter_region_name_en') }}">
                            @error('name_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
