...
@section('title', __('messages.add_case'))
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="mb-0">
                    <i class="ti ti-clipboard-plus me-2" style="color: #1e6f6a;"></i>
    ...
    <div class="row">
                ...
                <div class="section-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="owner_name" class="form-control" value="{{ old('owner_name') }}" placeholder="{{ __('messages.enter_owner_name') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.owner_phone') }}</label>
                            <input type="text" name="owner_phone" class="form-control" value="{{ old('owner_phone') }}" placeholder="{{ __('messages.enter_phone') }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="section-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="farm_location" class="form-control" value="{{ old('farm_location') }}" placeholder="{{ __('messages.enter_location') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.farm_type') }}</label>
                            <select name="farm_type" class="form-select">
                                <option value="">{{ __('messages.select') }}</option>
                                <option value="extensive" {{ old('farm_type') == 'extensive' ? 'selected' : '' }}>{{ __('messages.extensive') }}</option>
                                <option value="semi_intensive" {{ old('farm_type') == 'semi_intensive' ? 'selected' : '' }}>{{ __('messages.semi_intensive') }}</option>
                                <option value="intensive" {{ old('farm_type') == 'intensive' ? 'selected' : '' }}>{{ __('messages.intensive') }}</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.flock_size') }}</label>
                            <input type="number" name="flock_size" class="form-control" value="{{ old('flock_size') }}" min="0" placeholder="{{ __('messages.enter_flock_size') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.other_animals') }}</label>
                            <input type="text" name="other_animals" class="form-control" value="{{ old('other_animals') }}" placeholder="{{ __('messages.enter_other_animals') }}">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="section-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="number" name="age_years" class="form-control" value="{{ old('age_years') }}" min="0" placeholder="0">
                        </div>
                        <div class="col-md-3">
                            <label class="form-label">{{ __('messages.age_months') }}</label>
                            <input type="number" name="age_months" class="form-control" value="{{ old('age_months') }}" min="0" max="11" placeholder="0">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.breed') }}</label>
                            <select name="breed" class="form-select">
                                <option value="">{{ __('messages.select') }}</option>
                                <option value="local" {{ old('breed') == 'local' ? 'selected' : '' }}>{{ __('messages.breed_local') }}</option>
                                <option value="imported" {{ old('breed') == 'imported' ? 'selected' : '' }}>{{ __('messages.breed_imported') }}</option>
                                <option value="mixed" {{ old('breed') == 'mixed' ? 'selected' : '' }}>{{ __('messages.breed_mixed') }}</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.milking_ewes') }}</label>
                            <input type="number" name="milking_ewes" class="form-control" value="{{ old('milking_ewes') }}" min="0" placeholder="0">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.dry_ewes') }}</label>
                            <input type="number" name="dry_ewes" class="form-control" value="{{ old('dry_ewes') }}" min="0" placeholder="0">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6">
                ...
                <div class="section-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="milking_feed_type" class="form-control" value="{{ old('milking_feed_type') }}" placeholder="{{ __('messages.enter_feed_type') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.daily_consumption') }}</label>
                            <input type="text" name="milking_daily_consumption" class="form-control" value="{{ old('milking_daily_consumption') }}" placeholder="{{ __('messages.enter_daily_consumption') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.feeding_schedule') }}</label>
                            <input type="text" name="milking_feeding_schedule" class="form-control" value="{{ old('milking_feeding_schedule') }}" placeholder="{{ __('messages.enter_feeding_schedule') }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ __('messages.mineral_vitamin') }}</label>
                            <div class="form-check mt-2">
                                <input type="checkbox" name="milking_mineral_vitamin" class="form-check-input" id="milking_mineral_vitamin" {{ old('milking_mineral_vitamin') ? 'checked' : '' }}>
            ...
            <div class="section-card">
                ...
                <div class="section-body">
                    <textarea name="dry_ewes_nutrition" class="form-control" rows="3" placeholder="{{ __('messages.enter_nutrition_program') }}">{{ old('dry_ewes_nutrition') }}</textarea>
                </div>
            </div>
            ...
            <div class="section-card">
                ...
                <div class="section-body">
                    ...
                    <textarea name="lambs_health_problems" class="form-control" rows="2" placeholder="{{ __('messages.enter_health_problems') }}">{{ old('lambs_health_problems') }}</textarea>
                </div>
            </div>
                ...
                <div class="section-body">
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <textarea name="vaccination_history" class="form-control" rows="2" placeholder="{{ __('messages.enter_vaccination_history') }}">{{ old('vaccination_history') }}</textarea>
                        </div>
                        <div class="col-12">
                            <label class="form-label">{{ __('messages.medication_programs') }}</label>
                            <textarea name="medication_programs" class="form-control" rows="2" placeholder="{{ __('messages.enter_medication_programs') }}">{{ old('medication_programs') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-card">
                ...
                <div class="section-body">
                    <textarea name="notes" class="form-control" rows="2" placeholder="{{ __('messages.enter_notes') }}">{{ old('notes') }}</textarea>
                </div>
            </div>
        </div>
    </div>
                            ...
                            @if(isset($symptoms['clinical_signs']) && $symptoms['clinical_signs']->count() > 0)
                                @foreach($symptoms['clinical_signs'] as $symptom)
                                    <label class="symptom-item" data-category="clinical">
                                        <input type="checkbox" name="symptoms[]" value="{{ $symptom->id }}" {{ in_array($symptom->id, old('symptoms', [])) ? 'checked' : '' }}>
